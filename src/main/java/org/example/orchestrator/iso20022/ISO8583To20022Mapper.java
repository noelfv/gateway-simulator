...
import org.example.orchestrator.processes.ProcessMonitoring;
import org.example.orchestrator.processes.ProcessingResult;
import org.example.orchestrator.validations.FieldLocalCodeMapper;
import java.time.*;
    ...
    public static ISO20022 translateToISO20022(ISO8583 inputObject, Map<String, String> subFields) {
        ...
        try {
            ...
            * CONTEXT SECTION
            ...
            Boolean eCommerceIndicatorString= ISOSubFieldProcess.channelECommerceIndicator(inputObject, subFields, "PEER02");
            ...
            * ADDENDUM DATA SECTION
            ...
            fieldDto.setNetworkName("PEER02");
            ...
            return ISO20022.builder()
                    ...
                    .messageFunction(FieldLocalCodeMapper.getCode(TYPE_MESSAGE, "in", inputObject.getMessageType(), "PEER02"))
                    .socketPort("6034")
