...
import org.example.orchestrator.mastercard.subfields.ISOMastercardSubfieldsUtil;
...
public class ISO8583SubFieldsParser {
    ...
    public static Map<String, String> mapSubFieldsMastercard(Map<String, String> iso8583) {
        ...
        try {
            ...
            System.out.println(SUBFIELD_ERROR_MESSAGE + DASH + "processingCode");
        }
        ...
        try {
            ...
            System.out.println(SUBFIELD_ERROR_MESSAGE + DASH + "pointServiceEntryMode");
        }
        ...
        try {
            ...
            System.out.println(SUBFIELD_ERROR_MESSAGE + DASH + "additionalDataRetailer");
        }
        ...
        try {
            ...
            System.out.println(SUBFIELD_ERROR_MESSAGE + DASH + "additionalAmounts");
        }
        ...
        try {
            ...
            System.out.println(SUBFIELD_ERROR_MESSAGE + DASH + "posCardIssuer");
        }
