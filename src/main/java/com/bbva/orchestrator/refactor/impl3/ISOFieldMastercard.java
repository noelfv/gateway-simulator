...
public enum ISOFieldMastercard implements ISOField {
    ...
    PRIMARY_ACCOUNT_NUMBER(2, "primaryAccountNumber", ISODataType.NUMERIC, true, 2, new VarLengthPrefixParser(new NumericFieldParser())),
    ...
    ACQUIRING_INSTITUTION_IDENTIFICATION_CODE(32, "acquiringInstitutionIdentificationCode", ISODataType.NUMERIC, true, 2,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    FORWARDING_INSTITUTION_IDENTIFICATION_CODE(33, "forwardingInstitutionIdentificationCode", ISODataType.NUMERIC, true, 2,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    PAN_EXTENDED(34, "primaryAccountNumberExtended", ISODataType.ALPHA_NUMERIC, true, 2,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    TRACK_TWO_DATA(35, "trackTwoData", ISODataType.ALPHA_NUMERIC, true, 2,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    TRACK_THREE_DATA(36, "trackThreeData", ISODataType.ALPHA_NUMERIC, true, 2,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    ...
    ADDITIONAL_RESPONSE_DATA(44, "additionalResponseData", ISODataType.ALPHA_NUMERIC, true, 2,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    TRACK_ONE_DATA(45, "trackOneData", ISODataType.ALPHA_NUMERIC, true, 2,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    EXPANDED_ADDITIONAL_AMOUNTS(46, "expandedAdditionalAmounts", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    ADDITIONAL_DATA_NATIONAL_USE_2(47, "additionalDataNationalUse2", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    ADDITIONAL_DATA_RETAILER(48, "additionalDataRetailer", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    ...
    ADDITIONAL_AMOUNTS(54, "additionalAmounts", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    INTEGRATED_CIRCUIT_CARD(55,"integratedCircuitCard",ISODataType.HEXADECIMAL,true,3,new VarLengthPrefixParser(new HexadecimalFieldParser())),
    PAYMENT_ACCOUNT_DATA(56,"paymentAccountData",ISODataType.ALPHA_NUMERIC,true,3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    REDEMPTION_POINTS(58, "redemptionPoints", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    CAMPAIGN_DATA(59, "campaignData", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    POS_TERMINAL_DATA(60, "posTerminalData", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    POS_CARD_ISSUER(61, "posCardIssuer", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    POSTAL_CODE(62, "postalCode", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    NETWORK_DATA(63, "networkData", ISODataType.ALPHA_NUMERIC, true, 3,new VarLengthPrefixParser(new AlphaNumericFieldParser())),
    MESSAGE_AUTHENTICATION_CODE(64, "messageAuthenticationCode", ISODataType.HEXADECIMAL, false, 8,new HexadecimalFieldParser()),
    ADDITIONAL_RECORD_DATA(122,"additionalRecordData",ISODataType.ALPHA_NUMERIC,true,3,new VarLengthPrefixParser(new AlphaNumericFieldParser()));
