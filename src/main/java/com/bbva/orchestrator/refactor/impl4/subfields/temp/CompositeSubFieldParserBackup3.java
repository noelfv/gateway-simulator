...
public class CompositeSubFieldParserBackup3 implements FieldParserStrategy {
    ...
    public CompositeSubFieldParserBackup3(String compositeFieldId, Map<String, ISOSubField48Mastercard> subFieldDefinitions) {
        this.compositeFieldId = compositeFieldId;
        ...
        while (rawDataSegment.length() > currentOffset) {
            ...
            if(subFieldDef.isVariable()){
                ...
                for (Map.Entry<String, ISOSubField48Mastercard> entry : subSubFields.entrySet()) {
                    ...
                    parsedSubFieldsMap.put(subSubFieldId, subFieldResult.value());
                }
                /*
