...
public enum VisaISOField implements ISOField {
    ...
    ACQUIRING_INSTITUTION_IDENTIFICATION_CODE(32, "acquiringInstitutionIdentificationCode", ISODataType.NUMERIC, true, 2, new LlvarLengthPrefixParserVisa(new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser()))),
    FORWARDING_INSTITUTION_IDENTIFICATION_CODE(33, "forwardingInstitutionIdentificationCode", ISODataType.NUMERIC, true, 2, new LlvarLengthPrefixParserVisa(new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser()))),
    ...
    TRACK_TWO_DATA(35, "trackTwoData", ISODataType.NUMERIC, true, 2, new LlvarLengthPrefixParserVisa(new LlvarLengthPrefixParser(new AlphaNumericFieldParser()))),
