...
public enum Field48 implements ISOSubField {
    ...
    SF_48_82("82", "AdditionalDataRetailer.82", ISODataType.ALPHA_NUMERIC, true, 2, new AlphaNumericFieldParser()),
    SF_48_83("83", "AdditionalDataRetailer.83", ISODataType.ALPHA_NUMERIC, true, 1, new AlphaNumericFieldParser()),
    SF_48_90("90", "AdditionalDataRetailer.90", ISODataType.ALPHA_NUMERIC, true, 1, new AlphaNumericFieldParser()),
