...
public class OrchestratorFlowProcess implements IParser {
    ...
    public String convert20022to8583(ISO20022 iso20022) {
        ...
        if(!requiredUnparser(typeMessage)) {
            ...
            //TODO: Aca entra los mensajes 0100,0200,0400 y solo los que tengan el ProcessingResult nulo o vacio , se
            // ProcessingResult == (nulo o vacio) son operaciones que irian a HOST
    ...
    private boolean requiredUnparser(String messageType) {
        ...
        //return Set.of("0110", "0130", "0410", "0430", "0210","0800","0810","0302","0312").contains(messageType) || isMessageAdvices(messageType);
        return Set.of("0100", "0400").contains(messageType);
    }
