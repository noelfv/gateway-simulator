...
public class HexadecimalFieldParser implements FieldParserStrategy {
     ...
     * @throws ParserLocalException Si el segmento de datos es demasiado corto.
     */
    @Override
    public ParsedFieldResult parse(String rawDataSegment, IFieldDefinition fieldDefinition, NetworkHandlerField networkHandlerField) {
        try {
            ...
            throw new ParserLocalException("PGWP-00105","Error procesando campo " + fieldDefinition.getIdentifier() + " ¨[" + rawDataSegment + "]",e);
        }
    }
