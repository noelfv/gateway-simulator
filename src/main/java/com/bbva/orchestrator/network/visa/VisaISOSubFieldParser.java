...
public class VisaISOSubFieldParser {
    ...
    public VisaISOSubFieldParser(VisaHandlerField visaHandlerField) {
        this.visaHandlerField = visaHandlerField;
    }

    /**
     * Parsea los subcampos del Campo 48 (additionalDataRetailer) de un mensaje ISO 8583 de Mastercard.
     *
     * @param iso8583 Objeto ISO8583 que contiene el mensaje ISO 8583.
     * @return Un mapa donde las claves son los nombres de los subcampos y los valores son sus respectivos valores.
     ...
     * Si el Campo 48 no está presente, devuelve un mapa vacío.
     */
    public  Map<String, String> parseSubfields(Map<String, String> mainFieldsMap) {
        Map<String, String> allParsedSubfields = new LinkedHashMap<>();

        // 1. Obtener la data hexadecimal cruda del Campo 48
        String field48RawHex = mainFieldsMap.get(VisaISOField.ADDITIONAL_DATA_48.getName());
