...
public enum ISOFieldMastercard implements ISOField {
    ...
    SETTLEMENT_AMOUNT(5, "settlementAmount", ISODataType.NUMERIC_DECIMAL, false, 12),
    ...
    PIN_DATA(52, "pinData", ISODataType.HEXADECIMAL, false, 8),
    ...
    INTEGRATED_CIRCUIT_CARD(55,"integratedCircuitCard",ISODataType.HEXADECIMAL,true,3),
    ...
    MESSAGE_AUTHENTICATION_CODE(64, "messageAuthenticationCode", ISODataType.HEXADECIMAL, false, 8),
