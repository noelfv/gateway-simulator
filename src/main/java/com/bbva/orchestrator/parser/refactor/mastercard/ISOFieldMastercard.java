...
public enum ISOFieldMastercard implements ISOField {
    ...
    ADDITIONAL_DATA_48(48, "additionalDataRetailer", ISODataType.ALPHA_NUMERIC, true, 3,new LlvarLengthPrefixParser(new HexadecimalFieldParser())),
    //ADDITIONAL_DATA_48(48, "additionalDataRetailer", ISODataType.HEXADECIMAL, true, 3, new LlvarLengthPrefixParser(new HexadecimalFieldParser())), // LLLVAR (3 digitos de longitud)
