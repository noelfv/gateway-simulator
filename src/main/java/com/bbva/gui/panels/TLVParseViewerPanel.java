...
public class TLVParseViewerPanel extends AbstractBasePanel {
    ...
    private void initializeComponents() {
        ...
        inputTextPanel = new InputTextPanel("Mensaje de entrada", "Parser", "Limpiar");
    ...
    private void setupEventHandlers() {
        ...
        registerSecondaryButton(inputTextPanel, () -> clearFields(inputTextPanel, outputTextPanel, treeStructurePanel, "TLV"));
