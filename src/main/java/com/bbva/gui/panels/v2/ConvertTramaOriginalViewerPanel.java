...
public class ConvertTramaOriginalViewerPanel extends JPanel {

    private static final Logger LOGGER = LoggerFactory.getLogger(ConvertTramaOriginalViewerPanel.class);
    ...
    public ConvertTramaOriginalViewerPanel(BeanProviderInstance beanProviderInstance) {
    ...
    private void parseMessage() {
        ...
        try {
           ...
           // mapValues = delegateParser.parser(inputMessage);
            mapValues =ISO8583Processor.createMapFieldsISO8583Mastercard(inputMessage);
