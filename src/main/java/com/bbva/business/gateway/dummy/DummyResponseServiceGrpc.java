...
public final class DummyResponseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.bbva.business.gateway.dummy.Iso20022DummyRequest,
      com.bbva.business.gateway.dummy.Iso20022DummyResponse> getGetDummyResponseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDummyResponse",
      requestType = com.bbva.business.gateway.dummy.Iso20022DummyRequest.class,
      responseType = com.bbva.business.gateway.dummy.Iso20022DummyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.bbva.business.gateway.dummy.Iso20022DummyRequest,
      com.bbva.business.gateway.dummy.Iso20022DummyResponse> getGetDummyResponseMethod() {
    io.grpc.MethodDescriptor<com.bbva.business.gateway.dummy.Iso20022DummyRequest, com.bbva.business.gateway.dummy.Iso20022DummyResponse> getGetDummyResponseMethod;
      ...
      synchronized (DummyResponseServiceGrpc.class) {
        if ((getGetDummyResponseMethod = DummyResponseServiceGrpc.getGetDummyResponseMethod) == null) {
          DummyResponseServiceGrpc.getGetDummyResponseMethod = getGetDummyResponseMethod =
              io.grpc.MethodDescriptor.<com.bbva.business.gateway.dummy.Iso20022DummyRequest, com.bbva.business.gateway.dummy.Iso20022DummyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDummyResponse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bbva.business.gateway.dummy.Iso20022DummyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bbva.business.gateway.dummy.Iso20022DummyResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getDummyResponse(com.bbva.business.gateway.dummy.Iso20022DummyRequest request,
        io.grpc.stub.StreamObserver<com.bbva.business.gateway.dummy.Iso20022DummyResponse> responseObserver) {
  ...
  public static final class DummyResponseServiceStub
    ...
    /**
     */
    public void getDummyResponse(com.bbva.business.gateway.dummy.Iso20022DummyRequest request,
        io.grpc.stub.StreamObserver<com.bbva.business.gateway.dummy.Iso20022DummyResponse> responseObserver) {
  ...
  public static final class DummyResponseServiceBlockingStub
    ...
    /**
     */
    public com.bbva.business.gateway.dummy.Iso20022DummyResponse getDummyResponse(com.bbva.business.gateway.dummy.Iso20022DummyRequest request) {
  ...
  public static final class DummyResponseServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bbva.business.gateway.dummy.Iso20022DummyResponse> getDummyResponse(
        com.bbva.business.gateway.dummy.Iso20022DummyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DUMMY_RESPONSE:
          serviceImpl.getDummyResponse((com.bbva.business.gateway.dummy.Iso20022DummyRequest) request,
              (io.grpc.stub.StreamObserver<com.bbva.business.gateway.dummy.Iso20022DummyResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.bbva.business.gateway.dummy.Iso20022DummyRequest,
              com.bbva.business.gateway.dummy.Iso20022DummyResponse>(
  ...
  private static abstract class DummyResponseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.bbva.business.gateway.dummy.Dummy.getDescriptor();
    }
