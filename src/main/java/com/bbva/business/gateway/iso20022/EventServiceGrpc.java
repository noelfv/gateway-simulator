...
public final class EventServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "b.gateway.v1.EventService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.bbva.business.gateway.iso20022.Iso20022Request,
      com.bbva.business.gateway.iso20022.Iso20022Response> getPostEventMethod;
  ...
  public static io.grpc.MethodDescriptor<com.bbva.business.gateway.iso20022.Iso20022Request,
      com.bbva.business.gateway.iso20022.Iso20022Response> getPostEventMethod() {
    io.grpc.MethodDescriptor<com.bbva.business.gateway.iso20022.Iso20022Request, com.bbva.business.gateway.iso20022.Iso20022Response> getPostEventMethod;
    if ((getPostEventMethod = EventServiceGrpc.getPostEventMethod) == null) {
      synchronized (EventServiceGrpc.class) {
        if ((getPostEventMethod = EventServiceGrpc.getPostEventMethod) == null) {
          EventServiceGrpc.getPostEventMethod = getPostEventMethod =
              ...
              .setSchemaDescriptor(new EventServiceMethodDescriptorSupplier("PostEvent"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void postEvent(com.bbva.business.gateway.iso20022.Iso20022Request request,
        io.grpc.stub.StreamObserver<com.bbva.business.gateway.iso20022.Iso20022Response> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPostEventMethod(), responseObserver);
    }
  }
  ...
  public static final class EventServiceStub
    ...
    /**
     */
    public void postEvent(com.bbva.business.gateway.iso20022.Iso20022Request request,
        io.grpc.stub.StreamObserver<com.bbva.business.gateway.iso20022.Iso20022Response> responseObserver) {
  ...
  public static final class EventServiceBlockingStub
    ...
    /**
     */
    public com.bbva.business.gateway.iso20022.Iso20022Response postEvent(com.bbva.business.gateway.iso20022.Iso20022Request request) {
  ...
  public static final class EventServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bbva.business.gateway.iso20022.Iso20022Response> postEvent(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_POST_EVENT:
          serviceImpl.postEvent((com.bbva.business.gateway.iso20022.Iso20022Request) request,
              (io.grpc.stub.StreamObserver<com.bbva.business.gateway.iso20022.Iso20022Response>) responseObserver);
          break;
        default:
