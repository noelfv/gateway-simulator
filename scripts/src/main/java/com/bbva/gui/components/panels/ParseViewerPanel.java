...
public class ParseViewerPanel extends JPanel {
    ...
    private ContextDataGui contextDataGui;
    ...
    private void setupEventHandlers() {
        ...
        if (parserFactory == null) {
            ...
            contextDataGui=ApplicationContextProvider.getBean(ContextDataGui.class);
        }
        System.out.println("DelegateParser bean: " + delegateParser);
        System.out.println("DelegateMapper bean: " + delegateMapper);
        System.out.println("ContextDataGui bean: " + contextDataGui);
    ...
    private void parseMessage() {
        try {
            HeadersDTO headers = new HeadersDTO("1", "1", "1","PEER01", "9097","true");
            contextDataGui.initialize(headers);
           ...
           /* Map<String, String> fieldsValues = delegateMapper.unMapper(iso20022);
            ...
            if(contextDataGui!=null){
                contextDataGui.clear();
            }
        }
    }
