...
public enum VisaISOField implements ISOField {
    ...
    //PRIMARY_ACCOUNT_NUMBER(2, "primaryAccountNumber", ISODataType.NUMERIC, true, 2, new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    PRIMARY_ACCOUNT_NUMBER(2, "primaryAccountNumber", ISODataType.NUMERIC, true, 2, new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    ...
    ACQUIRING_INSTITUTION_IDENTIFICATION_CODE(32, "acquiringInstitutionIdentificationCode", ISODataType.NUMERIC, true, 2,new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    FORWARDING_INSTITUTION_IDENTIFICATION_CODE(33, "forwardingInstitutionIdentificationCode", ISODataType.NUMERIC, true, 2,new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    ...
    ADDITIONAL_DATA_48(48, "additionalDataRetailer", ISODataType.ALPHA_NUMERIC, true, 2,new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    ...
    TRANSACTION_DATA(104, "transactionData",ISODataType.ALPHA_NUMERIC,true,2,new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    ...
    KEY_MANAGEMENT(120, "keyManagement", ISODataType.HEXADECIMAL, true, 3,new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    ...
    CRYPTOGRAPHIC_SERVICE_MESSAGE(123, "cryptographicServiceMessage", ISODataType.HEXADECIMAL, true,3,new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
    INFO_TEXT(124, "infoText", ISODataType.ALPHA_NUMERIC, true, 3,new LlvarLengthPrefixParser(new AlphaNumericDecoratorFieldParser())),
