...
import com.bbva.orchestrator.core.exception.FlowHostResponseException;
...
public class DefaultDelegateMapper implements ISO20022DelegateMapper {
    ...
    public ISO20022 mapper(ISO8583 input, Map<String, String> subFields) {
        try {
            ...
            if(isResponseHost(input.getMessageType())){
                throw new FlowHostResponseException("Flow Asynchronous");
            }
            ...
            ISO20022.ISO20022Builder iso20022Builder = ISO20022.builder()
                    ...
                    .monitoring(monitoringService.insertMonitoring(input, environment, transaction));//Esto se deberia de setear en el mapper de la respuesta
        ...
        } catch (FlowHostResponseException e) {
            return createISO20022ToHost(input,subFields);
    ...
    private ISO20022 createISO20022ToHost(ISO8583 input, Map<String, String> subFields) {
