...
public class ISO8583Context {
    ...
    public static void storeISO8583(ISO8583 iso8583, Map<String, String> mapValuesOrigin,ISO8583DelegateParser delegateParser) {
        ...
        String tramSensitiveFields= delegateParser.unParserPlainText(mapSensitiveFields);
