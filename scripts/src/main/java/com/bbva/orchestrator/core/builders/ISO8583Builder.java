...
public class ISO8583Builder {
    ...
    public ISO8583Builder(ContextData contextData) {
        this.contextData = contextData;
    }


    public  ISO8583 buildISO8583(Map<String, String> mapValues, ISO8583DelegateParser delegateParser) {

        contextData.storeISO8583(null, mapValues, delegateParser);
        return null;
    }
    ...
    public static Map<String,String> logicResponse( Map<String,String>  mappedFields){
        //Debe traer un mapa de valores de configuracion de campos
        //CASO 1
        Map<Integer,String> mapISO=new HashMap<>();
        mapISO.put(2,"4555651234666666");
        mapISO.put(3,"002000");
        mapISO.put(4,"000000176000");
        mapISO.put(5,"5");
        mapISO.put(6,"6");
        mapISO.put(7,"7");
        //prepare logic fields
        //List<Integer> logic(typeMessage,Map<String,String> mappedFields)
        List<Integer> logicFields= List.of(5,6,7);
        // Conserva solo las entradas cuyas claves están en logicFields
        mapISO.keySet().retainAll(logicFields);

        //CASO 2
        Map<String,String> mapISOString=new HashMap<>();
        mapISOString.put("prymaryAccountNumber","4555651234666666");
        mapISOString.put("processingCode","002000");
        mapISOString.put("transactionAmount","000000176000");
        mapISOString.put("date","5");
        mapISOString.put("time","6");
        mapISOString.put("systemTrace","7");

        List<String> logicFieldsString= List.of("date","time","systemTrace");
        mapISOString.keySet().retainAll(logicFieldsString);
